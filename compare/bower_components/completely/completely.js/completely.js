...
function completely(container, config) {
    ...
    config.dropDownOnHoverBackgroundColor = config.dropDownOnHoverBackgroundColor || '#fff';
    config.dropDownOnHoverColor =           config.dropDownOnHoverColor || '#428bca';
        ...
        var p = {
            ...
            highlight : function(index) {
                if (oldIndex !=-1 && rows[oldIndex]) { 
                    ...
                    rows[oldIndex].style.color = config.color;
                }
                rows[index].style.backgroundColor = config.dropDownOnHoverBackgroundColor; // <-- should be config
                rows[index].style.color = config.dropDownOnHoverColor; // <-- should be config
                oldIndex = index;
            },
